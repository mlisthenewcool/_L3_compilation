...
void initialise_premiers()
{
	...
	premiers[_expression_][CARRE] = 1;//added
	...
	premiers[_conjonction_][CARRE] = 1; //added
	...
	premiers[_expArith_][CARRE] = 1;//added
	...
	premiers[_terme_][CARRE] = 1;//added

	premiers[_termeBis_][FOIS] = 1;
	premiers[_termeBis_][DIVISE] = 1;
	premiers[_termeBis_][MODULO] = 1;
	...
	premiers[_negation_][CARRE] = 1;//added
	...
	premiers[_listeExpressions_][CARRE] = 1;//added
